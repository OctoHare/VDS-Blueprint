...
Теперь ваша панель доступна по адресу `https://megaserver.ru/3xpanel/`. Первый вход в панель 3X-UI c логином `admin` и паролем `admin`.

Далее в меню панели проводим первичные настроки:
